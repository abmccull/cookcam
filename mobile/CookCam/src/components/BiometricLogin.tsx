...
const BiometricLogin: React.FC<BiometricLoginProps> = ({
  ...
  const checkBiometricAvailability = async () => {
    try {
      ...
      const hasCredentials =
        (await biometricService.getStoredCredentials()) !== null;
      ...
      if (canUse) {
        ...
        logger.debug("❌ BiometricLogin: Not available", {
          reason: !capabilities.isAvailable
            ? "No biometric hardware/enrollment"
            : !isEnabled
              ? "Not enabled in app"
              : !hasCredentials
  ...
  return (
    ...
    >
      ...
      {showLabel && (
        <Text
          style={[styles.label, getTextSize(), disabled && styles.disabledText]}
        >
