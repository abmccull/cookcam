...
const BiometricEnablementModal: React.FC<BiometricEnablementModalProps> = ({
  ...
  const getBiometricIcon = () => {
    if (biometricMethod.includes("Face ID")) {
      ...
      biometricMethod.includes("Touch ID") ||
      biometricMethod.includes("Fingerprint")
    ) {
      ...
      <Animated.View style={[styles.overlay, { opacity: fadeAnim }]}>
        ...
        >
          ...
          {showSuccess ? (
            // Success State
            <Animated.View
              style={[styles.content, { transform: [{ scale: successScale }] }]}
            >
              ...
              <Text style={styles.successMessage}>
                You can now use {biometricMethod} to sign in quickly and
                securely.
              </Text>
            </Animated.View>
          ) : (
            ...
            <View style={styles.content}>
              ...
              <Text style={styles.message}>
                Use {biometricMethod} for faster and more secure login. Your
