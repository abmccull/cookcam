...
describe('OpenAI Service', () => {
                ...
                recipes: [
                  {
                    ...
                    totalTimeMinutes: 20,
                    difficulty: 'Beginner',
                    oneSentenceTeaser: 'Plant-based goodness',
                  },
                  {
                    title: 'Tofu Scramble',
                    cuisine: 'American',
                    totalTimeMinutes: 15,
                    difficulty: 'Beginner',
                    oneSentenceTeaser: 'Protein-packed breakfast',
                  },
                  {
                    ...
                    oneSentenceTeaser: 'Spicy and satisfying',
                  },
                ],
              }),
            },
  ...
  describe('generateFullRecipe', () => {
    it('should generate a complete recipe', async () => {
                ...
                steps: [
                  {
                    ...
                    technique: 'boiling',
                    proTip: 'Salt the water generously',
                  },
                ],
              }),
            },
      ...
      const result = await generateFullRecipe('Tomato Basil Pasta', {
    ...
    it('should handle API errors gracefully', async () => {
      ...
      await expect(
        generateFullRecipe('Test Recipe', { detectedIngredients: ['test'] })
